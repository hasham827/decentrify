...
import { revokeAccessComponent } from './revokeAccess/revokeAccess.component';
  ...
  declarations: [
    AppComponent,
    HomeComponent,
    degreeAssetComponent,
    visitorParticipantComponent,
    networkRegulatorParticipantComponent,
    instituteParticipantComponent,
    employerParticipantComponent,
    studentParticipantComponent,
    invokeAccessComponent,
    viewDegreeComponent,
